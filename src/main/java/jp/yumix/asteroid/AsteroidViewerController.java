...
import jp.yumix.asteroid.color.ColorPosition;
import jp.yumix.asteroid.color.ColorTemperature;
import jp.yumix.asteroid.color.XYZColor;
...
public class AsteroidViewerController implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
		ObservableList<String> list = FXCollections.observableArrayList(Arrays.stream(Asteroid.values()).map(e -> e.name()).toArray(i -> new String[i]));
